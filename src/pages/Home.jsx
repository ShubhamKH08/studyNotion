    ...
    <div className="min-h-screen w-screen inset-0 m-0 ">
      <div>
        ...
        <Form/>
          ...
          <div className="box1c mx-auto box1c mt-38 h-[48px] w-[308px] gap-24">
            <div className="flex">
              <div className=""></div>
        ...
        <div className=" box2  h-[522px]  p-[90px, 120px, 90px, 120px] gap-[98px]">
          <div className="flex">
              ...
              <div className="flex  justify-center flex-wrap items-center">
                ...
                <div className="w-full md:w-[300px] h-[300px] bg-[#161D29] ml-12 mt-8 shadow-[12px 12px 0 0 #FFD60A]">
                  <div className="w-full md:w-[300px] h-[244px] p-[16px 24px] border-t-[1px] border-[1px]  border-[#424854] gap-16">
                    <div className="mt-8 ml-5 w-[260px] h-7 text-xl font-semibold font-inter text-20 leading-28 tracking-normal text-left text-[#DBDDEA]">
                      Learn CSS
                    </div>
                    <div className="w-[293.33px] h-96 text-md font-normal font-inter text-16 leading-24 tracking-normal text-left text-[#6E727F] mt-5 ml-6">
